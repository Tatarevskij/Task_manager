...
/**
 * Class m190416_174333_foreignKeys
 */
class m190416_174333_foreignKeys extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    public function safeDown()
    {
        ...
        $this -> dropForeignKey('fx_task_user1', 'task', ['creator_id']);
        $this -> dropForeignKey('fx_task_user2', 'task', ['updater_id']);
    ...
    {
        echo "m190416_174333_foreignKeys cannot be reverted.\n";
